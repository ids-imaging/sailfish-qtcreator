    ...
    , m_updateConnection(false)
{
    ...
    connect(m_ui->virtualMachineSettingsWidget, &MerVirtualMachineSettingsWidget::memorySizeChanged,
            this, &MerSdkDetailsWidget::memorySizeChanged);
    ...
    connect(m_ui->virtualMachineSettingsWidget, &MerVirtualMachineSettingsWidget::vdiSizeChnaged,
            this, &MerSdkDetailsWidget::vdiSizeChnaged);
...
void MerSdkDetailsWidget::setSdk(const MerSdk *sdk)
{
    ...
    m_ui->virtualMachineSettingsWidget->setVdiInfo(sdk->vdiPath(), sdk->vdiCapacityMb(), sdk->vdiSizeOnDiskMb());
}
...
void MerSdkDetailsWidget::setVmOffStatus(bool vmOff)
{
    ...
    m_ui->virtualMachineSettingsWidget->setCanEdit(vmOff);
}
