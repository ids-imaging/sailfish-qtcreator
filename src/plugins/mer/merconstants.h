...
const char VDI_PATH[] = "VdiPath";
const char VDI_CAPACITY_MB[] = "VdiCapacity";
const char VDI_SIZE_MB[] = "VdiSize";
const char ID[] = "Id";
...
const char MER_VIRTUAL_MACHINE_MEMORY_SIZE[] = "MER_VIRTUAL_MACHINE_MEMORY_SIZE";
const char MER_VIRTUAL_MACHINE_CPU_COUNT[] = "MER_VIRTUAL_MACHINE_CPU_COUNT";
const char MER_VIRTUAL_MACHINE_VDI_SIZE[] = "MER_VIRTUAL_MACHINE_VDI_SIZE";
